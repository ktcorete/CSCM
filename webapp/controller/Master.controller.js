		...
		return BaseController.extend("csc.cscm.controller.Master", {
			...
			onOpenViewSettings : function (oEvent) {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("csc.cscm.view.ViewSettingsDialog", this);
